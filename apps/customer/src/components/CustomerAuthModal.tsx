        ...
        <div className="bg-gradient-to-r from-brand-500 to-brand-600 p-6 text-white relative">
          ...
          <div className="flex items-center gap-3 mb-2">
            ...
            <div>
              ...
              <p className="text-brand-100 text-xs">Verify your details to place your order</p>
            </div>
          </div>
        </div>
          ...
          {step === 1 ? (
            <form onSubmit={handleSendOtp} className="space-y-4">
              <div>
                ...
                <div className="relative">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-slate-800 border border-slate-700 rounded-2xl text-white focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 transition-all placeholder:text-slate-600"
                  />
                </div>
              </div>
              ...
              <button
                type="submit"
                disabled={loading}
                className="w-full bg-brand-500 hover:bg-brand-600 disabled:opacity-50 text-white font-bold py-4 rounded-2xl flex items-center justify-center gap-2 group transition-all shadow-lg shadow-brand-500/20 active:scale-[0.98] mt-6"
              >
            ...
            <form onSubmit={handleVerifyOtp} className="space-y-4">
              <div className="text-center mb-6">
                ...
                <button type="button" onClick={() => setStep(1)} className="text-brand-400 text-xs mt-2 hover:underline">
                  Change number
                </button>
              </div>

              <div>
                <label className="block text-xs font-semibold text-slate-400 uppercase tracking-wider mb-1.5 ml-1 text-center">
                  Verification Code
                </label>
                <div className="relative max-w-[200px] mx-auto">
                  ...
                  <input
                    ...
                    className="w-full pl-10 pr-4 py-3 bg-slate-800 border border-slate-700 rounded-2xl text-white focus:border-brand-500 focus:outline-none focus:ring-1 focus:ring-brand-500 transition-all placeholder:text-slate-600 text-center tracking-[0.5em] font-bold text-lg"
                  />
                </div>
              </div>
