...
router.post('/subscription/pay', requireRole(['OWNER', 'MANAGER']), asyncHandler(async (req, res) => {
...
router.get('/subscription/payments', requireRole(['OWNER', 'MANAGER']), asyncHandler(async (req, res) => {
...
// ── Coupons ─────────────
router.get('/coupons', requireRole(['OWNER', 'MANAGER']), asyncHandler(async (req, res) => {
...
router.post('/coupons', requireRole(['OWNER', 'MANAGER']), asyncHandler(async (req, res) => {
...
router.delete('/coupons/:id', requireRole(['OWNER', 'MANAGER']), asyncHandler(async (req, res) => {
...
// ── Reviews ─────────────
router.get('/reviews', requireRole(['OWNER', 'MANAGER']), asyncHandler(async (req, res) => {
